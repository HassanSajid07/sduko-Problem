...
def mrv_backtracking(variables, domain, constraints):
    assignment = {}
    return mrv_backtrack(assignment, variables, domain, constraints)

def mrv_backtrack(assignment, variables, domain, constraints):
    ...
    for value in domain[var]:
        if is_consistent(var, value, assignment, constraints):
            ...
            if forward_check(var, value, assignment, constraints, updated_domain):
                result = mrv_backtrack(assignment, variables, updated_domain, constraints)
